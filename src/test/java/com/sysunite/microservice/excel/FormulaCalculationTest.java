...
public class FormulaCalculationTest extends BaseTest {
  ...
  public void inject() throws IOException, NoSuchAlgorithmException {
    ...
    File template = new File(Resources.getResource("test-inject-2-template.xlsx").getPath());
    ...
    List<String> shouldBeContent = getHashesFromZipFile(new File(Resources.getResource("test-inject-2.xlsx").getPath()));
